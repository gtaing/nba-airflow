TEAM_METRICS = ['pts', 'fgm', 'fga', 'fg_pct', 'fg3m', 'fg3a', 'fg3_pct', 'ftm', 'fta', 'ft_pct', 'oreb', 'dreb', 'reb', 'ast']

TEAM_CONFIG_MAP = {
    "home": {
        "team_metrics": {f"{metric}_home": f"team_{metric}" for metric in TEAM_METRICS},
        "opponent_metrics": {f"{metric}_away": f"opponent_{metric}" for metric in TEAM_METRICS},
        "renaming": {
            "wl_home": "win_loss",
    ...
    "away": {
        ...
        "opponent_metrics": {f"{metric}_home": f"opponent_{metric}" for metric in TEAM_METRICS},
        "renaming": {
            "wl_away": "win_loss",
